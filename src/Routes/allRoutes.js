...
const authProtectedRoutes = [
  //my all routes
  { path: "/all-properties", component: <ListTables /> },
  { path: "/all-agents", component: <BasicTables /> },
  { path: "/lenders", component: <FileManager /> },
  { path: "/agents", component: <MailInbox /> },
  { path: "/rent-properties", component: <EcommerceOrders /> },
  { path: "/sale-properties", component: <EcommerceAddProduct /> },
  { path: "/all-titles", component: <Calendar /> },
  { path: "/agents-titles", component: <MonthGrid /> },
  { path: "/landers-titles", component: <EcommerceProducts /> },
  { path: "/agent-types", component: <EcommerceProductDetail /> },
  { path: "/all-properties-types", component: <EcommerceCustomers /> },
  { path: "/sale-properties-type", component: <EcommerceCart /> },
  { path: "/rent-properties-type", component: <EcommerceCheckout /> },

  //this is already existing routes
...
const publicRoutes = [
  ...
  { path: "/reset-password/:resetToken", component: <ForgetPasswordPage /> },

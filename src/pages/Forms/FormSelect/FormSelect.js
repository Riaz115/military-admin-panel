          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use<code> multiple</code> attribute to select multiple
                    values and <code>size="your value"</code> attribute to show
                    a number of choice option within a select area.
                  </p>
                  <div className="live-preview">
                    <Row className="gy-4">
                      <Col lg={6}>

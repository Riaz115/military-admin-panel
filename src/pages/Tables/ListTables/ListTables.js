...
import userIcon from "../../../assets/images/myicon.png";
...
const ListTables = () => {
  ...
  const getAllProperties = async () => {
    const url = "https://backend.militaryhousingcenter.net/api/property/all";
    try {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="All Properties" pageTitle="Tables" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
              ...
              <Row>
                <Col sm={6} className="my-2">
                  <div className="form-group">
                    <label>House For What</label>
                    <select
                      name="forwhat"
                      value={propertyInfo.forwhat}
